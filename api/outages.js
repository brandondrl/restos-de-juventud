...
module.exports = async (req, res) => {
  ...
  if (req.method === 'POST') {
    const { id, start, end, duration_minutes, notes } = req.body;
    await sql`
      INSERT INTO outages (id, start_time, end_time, duration_minutes, notes)
      VALUES (${id}, ${start}, ${end ?? null}, ${duration_minutes ?? null}, ${notes ?? null})
