...
async function initDb(sql) {
  ...
  await sql`CREATE TABLE IF NOT EXISTS outages (id TEXT PRIMARY KEY, user_id TEXT, start_time TEXT NOT NULL, end_time TEXT, duration_minutes REAL, type TEXT DEFAULT 'corte', notes TEXT, created_at TEXT DEFAULT NOW()::text)`;
